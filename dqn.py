...
class ActorCritic:
    def __init__(self, obs_shape, num_actions,  device, lr,
        ...
        self.metrics = {}
        self.encoder = Encoder(obs_shape, hidden_dim, use_image, use_language_state, use_goal, vocab, goal_encoder_type, device, other_dim)
        self.critic = Critic2(self.encoder, obs_shape, num_actions, hidden_dim, use_image, use_language_state, use_goal, vocab, goal_encoder_type, device, other_dim).to(device)
        self.critic_target = Critic2(self.encoder, obs_shape, num_actions,
                                    hidden_dim, use_image, use_language_state, use_goal, vocab, goal_encoder_type, device, other_dim).to(device)
    ...
    def act(self, obs, step, eval_mode, other_model=None):
        ...
        # print(f'action_probes = {action_probs}')
    ...
    def update_critic(self, batch, step):
        ...
        with torch.no_grad():
            ...
            target_value = reward + discount * value_next
        ...
        advantage = (reward + discount * value_next.detach()) - value.detach()
